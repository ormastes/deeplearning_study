...
class VirtualEmbeddingV2(Embedding):
...
class TestModuleV2(torch.nn.Module):
    def __init__(self, config, tokenizer):
        ...
        self.embedding_v2 = VirtualEmbeddingV2(tokenizer.max_voca_id(), tokenizer.max_synonym_id(), config.voca_embed_dim, tokenizer)
...
if __name__ == "__main__":
    ...
    model = TestModuleV2(config, tokenizer)
