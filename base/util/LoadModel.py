...
def load_weights(gpt, gpt_hf, config):
    ...
    gpt.embedded.pos_embed.weight = assign_check(gpt.embedded.pos_embed.weight, d["wpe.weight"])
    gpt.embedded.token_embed.weight = assign_check(gpt.embedded.token_embed.weight, d["wte.weight"])
