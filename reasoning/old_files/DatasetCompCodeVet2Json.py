...
mercury_dataset = cpp_dataset = load_dataset("Elfsong/Mercury")
dataset_save_path =  os.path.join(os.path.dirname(os.path.abspath(__file__)), "test_target_and_object")
json_save_dir = dataset_save_path
