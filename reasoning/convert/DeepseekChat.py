...
model_name = "Phpcool/DeepSeek-R1-Distill-SRE-Qwen-32B-INT8"#"bartowski/DeepSeek-R1-Distill-Qwen-32B-GGUF"
...
def chat(prompt, max_new_tokens=2000, temperature=0.7):
